...
--  Tabela: 26 (10 të detyrueshme + 16 domain)
...
-- ============================================================
--  BLLOKU B — TABELA DOMAIN (16 tabela)
-- ============================================================
...
CREATE TABLE Ingredients (
  ...
  unit             VARCHAR(20)    NOT NULL COMMENT 'kg, l, cope, g',
...
CREATE TABLE StoreOrders (
  ...
  status           ENUM('pending','approved','rejected','ready_for_pickup','picked_up','delivered','cancelled')
...
-- ============================================================
--  TABELA COUNT: 26 tabela (10 detyrueshme + 16 domain)
